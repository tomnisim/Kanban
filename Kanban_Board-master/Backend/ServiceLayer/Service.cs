...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class Service : IService
    {
        ...
        private BusinessLayer.UserController uc { get; set; }
        private BusinessLayer.BoardController bc { get; set; }
        /// <summary>
        ...
        {
            return this.us.Register(email, password, nickname, this.uc);
        }
        ...
        {
            return this.us.Register(email, password, nickname, this.uc, emailHost);
        }
        ...
        {
            return this.bs.AssignTask(email, columnOrdinal, taskId, emailAssignee);
        }
        ...
        {
            return this.bs.DeleteTask(email, columnOrdinal, taskId);
        }
        ...
        {
            return this.us.Login(email, password, uc);
        }
        ...
        {
            return this.us.Logout(email, uc);
        }
        ...
        {
            return this.bs.LimitColumnTasks(email, columnOrdinal, limit);
        }
        ...
        {
            return this.bs.ChangeColumnName(email, columnOrdinal, newName);
        }
        ...
        {
            return this.bs.AddTask(email, title, description, dueDate);
        }
        ...
        {
            return this.bs.UpdateTaskDueDate(email, columnOrdinal, taskId, dueDate);
        }
        ...
        {
            return this.bs.UpdateTaskTitle(email, columnOrdinal, taskId, title);
        }
        ...
        {
            return this.bs.UpdateTaskDescription(email, columnOrdinal, taskId, description);
        }
        ...
        {
            return this.bs.AdvanceTask(email, columnOrdinal, taskId);
        }
        ...
        {
            return this.bs.GetColumn(email, columnName);
        }
        ...
        {
            return this.bs.GetColumn(email, columnOrdinal);
        }
        ...
        {
            return this.bs.removeColumn(email, columnOrdinal);
        }
        ...
        public Response<Column> MoveColumnRight(string email, int columnOrdinal)//done all the way
        {
